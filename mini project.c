...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Chapra Express","Chennai Express","Kanpur Express","Chinhat Express","Airport Express","Tiger Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
getch();
    ...
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\t Brought To You By Harshit Raj");
    getch();
    return 0;
}
 ...
 login()
{
    ...
    char user[10]="harshit";
    char pass[10]="harshit";
    do
{
	system("cls");
	...
	i=0;
	//scanf("%s",&pword);
		if(strcmp(uname,"harshit")==0 && strcmp(pword,"harshit")==0)
	{
